...
main = proc()
	...
	print('person 2 age before del: ' call(get(vob-4 'get-from') list('persons' 2 'age')))
	vob-5 = call(get(vob-4 'del-from') list('persons' 2 'age'))
	print('person 2 age after del: ' call(get(vob-5 'get-from') list('persons' 2 'age')))

	# lets then commit changes to base object
	call(get(base 'commit') vob-5)
